...
import com.vision.visionpicturebackend.mapper.SpaceMapper;
...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    @Override
    public long addSpace(SpaceAddRequest spaceAddRequest, User logninUser) {
        //1.填充参数默认值
        ...
        Long userId = logninUser.getId();
        space.setUserId(userId);
        if(SpaceLevelEnum.COMMON.getValue() != space.getSpaceLevel()&&!userService.isAdmin(logninUser)){
